                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <form method="POST" action="{{ route("createModel") }}" enctype="multipart/form-data">
                                @csrf

                                <div class="form-group">
                                    <label for="">Nom (*)</label>
                                    <input type="text" class="form-control" value="{{ old("nomMoule") }}" name="nomMoule">
                                    @error('nomMoule')
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    <input type="checkbox" class="form-check-input" name="verouillerFichier" {{ old("verouillerFichier",false)==true ? "checked":"" }} >
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" value="{{ old("excelSheetPwd") }}" name="excelSheetPwd">
