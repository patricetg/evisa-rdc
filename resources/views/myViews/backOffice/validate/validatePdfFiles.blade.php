                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <form method="POST" action="{{ route("validatePdfFiles") }}" enctype="multipart/form-data">
                                @csrf

                                <div class="form-group">
                                    <label for="">Fichiers (*)</label>
                                    <input type="file" accept=".pdf" class="form-control-file" multiple name="filesToValidate[]">
