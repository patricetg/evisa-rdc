        ...
        <div class="text-block">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 v-center"><div class="img-hro" data-tilt data-tilt-max="4" data-tilt-speed="6000"><img style="height: 500px;" src="{{ asset("myFiles/images/passeport-2.png") }}" alt="title" class="img-fluid"></div></div>
                </div>
            </div>
        </div>
    </section>
